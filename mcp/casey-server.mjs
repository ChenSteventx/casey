...
function signEntityArgs(args) {
  ...
  return [
    ...
    ...flag('entity-observations', args.entityObservations), // v2 身份观察对账（agent-id-readback）：v2 draft 必带、v1 禁带，由 CLI fail-closed
