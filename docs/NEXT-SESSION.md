...
2. `docs/HANDOFF.md`（最新覆盖层即权威现状，顶节是 2026-08-07 夜）
...
- 2026-08-06/07 十三契约入 dev（本地零 push）：sleep 导入修 `8d0b0bc`、create 入口锚
  `158829d`、登录预算 `9bb2300`、post-nav 双锚 `db80a17`、open 搜索先行 `7f38606`、
  open 诊断 notes `97c0d83`、语义名回填 `8d0e6e3`、读回门丙路线 `a507f5c`、
  删除搜索修 `b6880e3`、观察让位 `d5ecbab`、意图号重绑 `b38c679`、基数门让位 `28e02a2`（现役顶端）。
