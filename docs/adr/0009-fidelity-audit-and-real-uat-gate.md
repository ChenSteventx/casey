...
- 状态：已取代（2026-07-15 起由 real-SUT-only 运行策略取代）
- 日期：2026-07-14

> 历史说明：本 ADR 记录旧的双层运行策略。当前公开发行版禁止启动、连接或回放 fake-SUT / fixture；它们只可静态阅读。行为验收和完成证据只来自联网的真实 SUT，现行边界以 `AGENTS.md`、Casey skill 与 `docs/runbooks/real-uat-runbook.md` 为准。
