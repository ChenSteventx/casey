...
//
// C1 openNode 可编译 + COMPILE_KNOWN_ATOMS 恰 18（setNodeField +1）+ agent.openToolPicker 不可编译
//    （继任反例真缝，长寿）。
...
// ---------- C1 编译原子集加法 + 例翻反例 ----------
await checkAsync('C1 workflow.openNode 可编译、COMPILE_KNOWN_ATOMS 恰 18、agent.openToolPicker 不可编译', async () => {
