...
// C1 两原子可编译+集恰 15；C2 compile 全程 events/observed/assertionAtoms 钉死；C3 mini 端到端 verdict 全 PASS；
...
// ---------- C1 两原子可编译 + 集恰 18 ----------
await checkAsync('C1 nav.workflowManagement/workflow.open 可编译；COMPILE_KNOWN_ATOMS 恰 18', async () => {
