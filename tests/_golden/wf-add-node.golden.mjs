...
// C1 addNode 可编译 + COMPILE_KNOWN_ATOMS 恰 17（selectNodeDropdown +1）+ agent.openToolPicker 不可编译（GRILL D5 继任反例真缝）；
...
// ---------- C1 编译原子加法 + 例翻反例 ----------
await checkAsync('C1 workflow.addNode 可编译、COMPILE_KNOWN_ATOMS 恰 17、agent.openToolPicker 不可编译', async () => {
