...
// C1 addNode 可编译 + COMPILE_KNOWN_ATOMS 恰 25（智能体工具首纵切 +7）+ agent.selectModel 不可编译；
...
// ---------- C1 编译原子加法 + 例翻反例 ----------
await checkAsync('C1 workflow.addNode 可编译、COMPILE_KNOWN_ATOMS 恰 25、agent.selectModel 不可编译', async () => {
