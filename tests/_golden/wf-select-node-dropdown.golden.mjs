...
//
// C1 selectNodeDropdown 可编译 + COMPILE_KNOWN_ATOMS 恰 17（selectNodeDropdown +1）+ agent.openToolPicker
...
// ---------- C1 编译原子集加法 + 例翻反例 ----------
await checkAsync('C1 workflow.selectNodeDropdown 可编译、COMPILE_KNOWN_ATOMS 恰 17、agent.openToolPicker 不可编译', async () => {
