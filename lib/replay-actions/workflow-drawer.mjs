...
export async function doBindAgent(page, ev, ctx) {
...
export async function doOpenNode(page, ev) {
...
export async function doSelectNodeDropdown(page, ev) {
...
export async function doSetNodeField(page, ev, ctx, {
  encodeNodeFieldReadback,
}) {
  const s = ev.semantic;
  ...
  const actual = encodeNodeFieldReadback({
    label,
    placeholder,
    exact,
    got,
