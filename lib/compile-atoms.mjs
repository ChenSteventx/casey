...
import { ENTITY_OBSERVATION_REGISTRY, ENTITY_KIND_COMPILE_CHANNELS } from './entity-observation-registry.mjs';
...
async function armWorkflowSourceReadback(run, { intentId, atom, evidenceStepId, openName, code }) {
  const ledger = run.identityLedger;
