...
export const IMPLEMENTED_KINDS = new Set(['noErrorEnvelope', 'urlPathname', 'streamReplyReceived', 'countChange', 'noPageError', 'textVisible', 'noErrorToast', 'replyContains', 'replyMatches', 'textHidden']);
...
function evalOne(a, c) {
  ...
  switch (a.kind) {
    ...
    // 其余 kind（inputReadback / dropdownReadback / requiredFilled / buttonState / switchState）
