...
export function resolveCaptureProjection({
  ...
  RESOLUTION_STATE.set(resolutionAuthority, {
    ...
    // formal events document 的稳定 provenance 只能来自本次 admitted capture；保持在
    // opaque resolution/grant 私有记录内，不向 caller 暴露，也不读取 wall clock/page URL。
    captureCreatedAt: inspected.capture.createdAt,
    captureStartPath: inspected.capture.startPath,
    projection: projected.projection,
    resolved: resolution.resolved,
    pending: resolution.pending,
    structural: resolution.structural,
