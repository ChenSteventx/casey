...
import { loadAiMiddleAccount } from './account-config.mjs';
...
export function loadCreds({ credsFile, env = process.env } = {}) {
  return loadAiMiddleAccount({ credsFile: credsFile || env.AT_CREDS_FILE || CREDS_FILE, env });
}
